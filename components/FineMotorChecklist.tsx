...
const FineMotorChecklist: React.FC<ChecklistPageProps> = ({
	age,
	tracker,
	updateTrackerValue,
	exitTracker,
	...
	return (
		<div data-testId="FineMotorChecklist"> 
			...
			<div className="px-0 md:px-5 lg:px-10 xl:px-20 2xl:px-40">
				<h1 className="text-xl bold md:font-normal lg:text-2xl mb-4">
					...
					<span className="text-elsa-blue">fine motor</span> skills?
				</h1>
				...
				{getMilestonesByAgeAndCategory(age, "fine motor").map(
					(milestone) => {
						const isChecked =
							tracker
								.find((track) => track.code === "fine motor")
								?.results.find(
...
export default FineMotorChecklist;
